...
<body>
    <div class="container">
        <h3>Product Lists</h3>
        <button type="button" class="btn btn-success mb-2" data-toggle="modal" data-target="#addModal">Add Product</button>
        |
        <button type="button" class="btn btn-success mb-2" data-toggle="modal" data-target="#addCatModal">Add Category</button>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a href="#" class="btn btn-danger btn-sm btn-delete" data-id="<?= $row->product_id;?>" data-toggle="modal" data-target="#deleteModal">Delete</a>
                    </td>
                </tr>
                <?php endforeach;?>
            </tbody>
...
<!-- End Modal Delete Product-->
 ...
 <!-- Modal Add Category-->
    <form action="/product/savecat" method="post">
